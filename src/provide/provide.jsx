...
const provide = () => {
  ...
  <VerticalTimelineElement
    ...
    contentStyle={{ background: '#0f6d53', color: 'yellow' ,boxShadow:' 12px 12px 14px grey'}}
  ...
  >
    ...
    <img class="img" src={img1} alt="" style={{width:'450px',height:'300px'}}/>
    <p>
  ...
  <VerticalTimelineElement
    ...
    contentStyle={{ background: '#0f6d53', color: 'black' ,boxShadow:' 12px 12px 14px grey'}}
    contentArrowStyle={{ borderRight: '7px solid  #0f6d53' }}
